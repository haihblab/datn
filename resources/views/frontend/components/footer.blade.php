    ...
    <div class="wrp">
        <div class="left">
            <div class="item">
                ...
                <a href="tel:0367530598" title="Hotline" class="tel">
                <span class="icon"><i class="fas fa-phone"></i></span>
                <span class="text">036.753.0598</span>
                </a>
            </div>
            <div class="item">
...
<div id="footer">
    <div class="wrp">
            ...
            <div class="left">
                ...
                <ul style="display: block;">
                    ...
                    <li>
                        ...
                        <a href="tel:0367530598" title="Hotline" class="text">Hotline: 036.753.0598</a>
                    </li>
                    <li>
                        <span class="icon"><i class="fas fa-envelope"></i></span>
                        <a href="mailto:laravel1998bn@gmail.com" title="email" class="text">laravel1998bn@gmail.com</a>
                    </li>
                </ul>
            </div>
            <div class="mid">
        ...
        <div class="bot">
            <p class="fRobotoB pb5 fs16">Hải Anh Watch</p>
            <h4 class="lh21">
...
<div id="commonBot">
    <div class="wrp">
        <div class="left">
            Copyright © 2008-2020 Hải Anh Watch.
        </div>
        <ul class="right">
            <li>
