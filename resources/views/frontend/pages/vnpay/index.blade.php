    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="{{route('shopping.payment.online.create')}}" id="create_form" method="post">       
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="{{$tst_total_money}}" readonly/>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="button" class="btn btn-default" onclick="history.back()">Quay trở lại</button>
